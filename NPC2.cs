...
public class NPC2 : MonoBehaviour
{
    ...
    public GameManager2 gameManager2; // Reference to the GameManager
    ...
    public void OnNoButtonClicked()
    {
        ...
        if (gameManager2 != null) gameManager2.NPCFinished();  // Notify GameManager that interaction is complete
    }
